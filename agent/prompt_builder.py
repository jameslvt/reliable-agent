...
from branding import get_full_identity
...
DEFAULT_AGENT_IDENTITY = get_full_identity()

HERMES_AGENT_HELP_GUIDANCE = ""   # 白标：移除 Hermes/Nous 自我介绍与文档链接
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "or troubleshoot this assistant platform itself — its CLI, config, models, providers, "
            "tools, skills, voice, gateway, plugins, or any feature — use the available skills "
            "and local help commands first so you don't have to guess or invent workarounds.\n"
...
def build_nous_subscription_prompt(valid_tool_names: "set[str] | None" = None) -> str:
    """White-label build: do not inject Nous subscription promotion."""
    return ""
